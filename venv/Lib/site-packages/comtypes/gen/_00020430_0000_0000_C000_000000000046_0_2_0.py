...
IFontDisp = Font
__all__ = [ 'VgaColor', 'OLE_CANCELBOOL', 'OLE_YSIZE_CONTAINER',
           'FONTITALIC', 'OLE_YSIZE_HIMETRIC', 'IFont', 'StdFont',
           'OLE_ENABLEDEFAULTBOOL', 'OLE_YPOS_PIXELS', 'StdPicture',
           'Default', 'OLE_HANDLE', 'OLE_YSIZE_PIXELS', 'Color',
           'OLE_XSIZE_HIMETRIC', 'OLE_XSIZE_PIXELS', 'OLE_TRISTATE',
           'OLE_COLOR', 'IPicture', 'OLE_YPOS_HIMETRIC',
           'OLE_YPOS_CONTAINER', 'OLE_XPOS_HIMETRIC',
           'FONTSTRIKETHROUGH', 'Gray', 'Monochrome', 'Unchecked',
           'Font', 'IFontDisp', 'Checked', 'OLE_OPTEXCLUSIVE',
           'FontEvents', 'OLE_XPOS_PIXELS', 'IFontEventsDisp',
           'FONTSIZE', 'OLE_XSIZE_CONTAINER', 'LoadPictureConstants',
           'FONTNAME', 'FONTUNDERSCORE', 'FONTBOLD',
           'OLE_XPOS_CONTAINER', 'Picture', 'IPictureDisp']
